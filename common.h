...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    inline void printContigBubbleInterleaved(const std::string &outputFilename, FILE *contigFP, const double coverageRatio, const double averageLength, const long maxKmerLength, const bool appendFlag=false)
    {
        std::ofstream out;
		...
		std::string seqNamePrefix1 = "primary_bubble";
		std::string seqNamePrefix2 = "secondary_bubble";
        ...
        while (fread(&length, sizeof(unsigned long long), 1, contigFP)) {
			...
			if (numSeq % 2 == 1)
				out << ">" << seqNamePrefix1 << bubbleID << "_len" << length << "_cov" << static_cast<unsigned short>(cov * coverageRatio + 0.5) << "_read" << averageLength << "_maxK" << maxKmerLength << "\n";
			else
				out << ">" << seqNamePrefix2 << bubbleID << "_len" << length << "_cov" << static_cast<unsigned short>(cov * coverageRatio + 0.5) << "_read" << averageLength << "_maxK" << maxKmerLength << "\n";
...
//////////////////////////////////////////////////////////////////////////////////////
    struct Region
    {
        ...
        Region(): id(0), start(0), end(0), value(0)  {}
        Region(const long i, const long s, const long e, const long v): id(i), start(s), end(e), value(v) {}
        Region(const Region &res) = default;
        Region &operator=(const Region &res) = default;
        ~Region() {}
        ...
        bool operator==(const Region &a) const
        {
			return (id == a.id && start == a.start && end == a.end && value == a.value);
        }
    };
//////////////////////////////////////////////////////////////////////////////////////
...
// this class has contig information from contig file.
    struct Contig
    {
        ...
        Contig(): seq(), name(0), numSeq(0), coverage() {}
